# mini-sprint-elicitacao-biblioteca-matheusobarros
...
### Dê uma nota entre 1 – 5, sobre: facilidade no login; 



### Dê uma nota entre 1 – 5, sobre: design e bugs do site. 
...
### A sequência de livros, estão separados por iniciais e categorias? Há algo que facilite a busca do livro? 




### O site disponibiliza o suporte de forma interativa e objetiva? Existe alguma dificuldade dos alunos no contato do suporte?
...
### Há alguma ferramenta que ao seu pensar, ajudaria na marcação de versos do texto? Tipo um marca texto online? 
